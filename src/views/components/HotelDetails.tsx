...
function HotelDetails({ i, item, handleClick }: any) {
  return (
    <Box sx={{ fontFamily: "sans-serif" }}>
      ...
      <Box sx={{ border: "1px solid lightgrey", mt: 2, mb: 2 }}>
        ...
        <Box sx={{ pl: 4, pr: 4, pb: 4, textAlign: "justify", lineHeight: 2 }}>
          ...
          InterContinental Marine Drive is strategically located in the heart of
          Mumbai's business & financial district, 1.5 kms from Nariman Point and
          3 kms from the Main Shopping Area of Colaba. Offering you the
          all-important luxury of saving time while on work. State-of-the-art
          business communication and meeting facilities further optimize time
          management.
        </Box>
        <Box>
